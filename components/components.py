...
def renderHtml(template_html, **kwargs):
    html_raw = open (os.path.dirname(os.path.abspath(__file__))+'/HTML/%s.html' % template_html,'r').read()
    t =r.Template(html_raw)
...
def getcss(filename):
    css = open(os.path.dirname(os.path.abspath(__file__))+'/HTML/%s.css' % filename,'r').read()
...
if __name__=="__main__":
    template_html_path = os.path.dirname(os.path.abspath(__file__))+'/HTML/%s.html' % "table.html"
